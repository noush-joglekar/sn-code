...
def parse_args():
    ...
    parser.add_argument("--stdev_frag", type=int, help="standard deviation of the fragment length [100]", default=100)
    ...
    with open(args.output, 'w') as outf:
        ...
        for r in pysam.AlignmentFile(args.ont, 'rb'):
            ...
            if not seq:
                continue
            total_sequences += 1
            if r.reference_name and r.reference_start and r.reference_end:
